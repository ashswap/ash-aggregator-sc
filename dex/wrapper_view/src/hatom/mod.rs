...
pub struct HatomViewRequest<M: ManagedTypeApi> {
...
pub trait WrapperModule {
    ...
    #[view(getHatom)]
    fn get_hatom(&self, request: MultiValueEncoded<HatomViewRequest<Self::Api>>) -> MultiValueEncoded<HatomView<Self::Api>> {
