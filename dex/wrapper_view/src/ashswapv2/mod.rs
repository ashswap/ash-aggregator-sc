...
pub trait WrapperModule {
    ...
    #[view(getAshswapV2)]
    fn get_ashswapv2(&self, pool_address: ManagedAddress, token_id_0: TokenIdentifier, token_id_1: TokenIdentifier) -> AshswapV2View<Self::Api> {
        ...
        AshswapV2View { total_supply, reserves, real_reserves, amp_factor, gamma, virtual_price, price_oracle, price_scale,
